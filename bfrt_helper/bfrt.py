...
class BfRtHelper:
    ...
    def create_write_request(self, program_name, atomicity=bfruntime_pb2.WriteRequest.\
    ...
    def create_action(self, table_name, action_name, action_params):
        ...
        if action_params is not None:
            for param_name, param_data in action_params.items():
                info_action_field = self.bfrt_info.get_action_field(table_name,
    ...
    def create_copy_to_cpu(self, program_name, port):
        ...
        bfrt_update.entity.table_entry.CopyFrom(table_entry)



    def create_set_pipeline_request(self, program_name,
            bfrt_path,
            context_path,
            binary_path):
        ...
        request.action = bfruntime_pb2.SetForwardingPipelineConfigRequest.VERIFY_AND_WARM_INIT_BEGIN_AND_END
